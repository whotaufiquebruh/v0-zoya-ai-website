...
const chatMessages = [
  ...
  {
    type: "zoya" as const,
    text: "I hear you. It&apos;s completely okay to feel that way. Would you like to talk about what&apos;s been weighing on your mind?",
    time: "now"
  },
  {
    type: "user" as const,
    text: "Just work stress and not sleeping well",
    time: "now"
  },
  {
    type: "zoya" as const,
    text: "I remember you mentioned having trouble sleeping last week too. Let&apos;s work through this together. What usually helps you unwind?",
    time: "now"
  }
]
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Zoya remembers your story and responds with genuine understanding
          </p>
        </motion.div>
              ...
              <AnimatePresence mode="popLayout">
                {chatMessages.slice(0, visibleMessages).map((message, index) => (
                  ...
                  >
                    ...
                    >
                      <p className="text-sm leading-relaxed">{message.text.replace(/&apos;/g, "'")}</p>
                    </div>
                  </motion.div>
                ))}
              </AnimatePresence>
