            ...
            <div className="px-8 pt-8 pb-8 flex flex-col items-center text-center">
              ...
              <div className="w-full space-y-3">
                <motion.button
                  ...
                  onClick={handleGuest}
                  disabled={loading}
                  className="w-full py-4 rounded-2xl gradient-pink text-white font-semibold text-sm flex items-center justify-center gap-2 shadow-glow-pink transition-opacity disabled:opacity-60"
                >
                  {loading ? (
                ...
                <motion.button
                  ...
                  onClick={handleGuest}
                  disabled={loading}
                  className="w-full py-3.5 rounded-2xl bg-secondary text-secondary-foreground font-medium text-sm flex items-center justify-center gap-2 hover:bg-secondary/80 transition-colors"
                >
