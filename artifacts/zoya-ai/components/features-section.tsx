...
const features = [
  {
    ...
    description: "Understands nuance, tone, and emotion in every conversation with human-like empathy."
  },
  {
    icon: Brain,
    title: "Smart Memory",
    description: "Remembers your stories, preferences, and conversations to build a deeper connection."
  },
  {
    icon: MessageSquare,
    title: "Human Typing Animation",
    description: "Natural conversation flow with realistic typing indicators and response timing."
  },
  {
    icon: Mic,
    title: "Voice Companion",
    description: "Speak naturally and hear Zoya respond with a warm, comforting voice."
  },
  {
    icon: Sparkles,
    title: "Mood-Aware Replies",
    description: "Detects your emotional state and adapts responses to match how you&apos;re feeling."
  },
  {
    icon: Moon,
    title: "Late-Night Comfort",
    description: "Always available for those quiet moments when you need someone to talk to."
  }
]
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto">
            Every feature designed to create meaningful, supportive conversations
          </p>
        </motion.div>
